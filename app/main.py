...
LANG = {
    "English": {
        ...
        "explainer_header": "5 · Farmer's Recommendation (Marathi + English)",
        "explainer_marathi": "📝 मराठीत",
        "explainer_english": "📝 In English",
        "explainer_source_gemini": "Generated by Gemini 2.0 (LLM)",
        "explainer_source_template": "Generated locally (template fallback — Gemini unavailable)",
    ...
    "हिंदी": {
        ...
        "explainer_header": "5 · किसान के लिए सिफारिश (मराठी + अंग्रेज़ी)",
        "explainer_marathi": "📝 मराठी में",
        "explainer_english": "📝 अंग्रेज़ी में",
        "explainer_source_gemini": "Gemini 2.0 (LLM) द्वारा निर्मित",
        "explainer_source_template": "स्थानीय टेम्प्लेट से निर्मित (Gemini अनुपलब्ध)",
    ...
    "मराठी": {
        ...
        "explainer_header": "5 · शेतकऱ्यांसाठी शिफारस (मराठी + इंग्रजी)",
        "explainer_marathi": "📝 मराठीत",
        "explainer_english": "📝 इंग्रजीत",
        "explainer_source_gemini": "Gemini 2.0 (LLM) ने तयार केलेले",
        "explainer_source_template": "स्थानिक टेम्प्लेटवरून (Gemini उपलब्ध नाही)",
        "shelf_life": "शेल्फ लाइफ",
...
with tab_dashboard:
    ...
    # --- Agent 5: Farmer's natural-language recommendation -----------------
    explanation = result.get("explanation") or {}
    if explanation:
        st.divider()
        st.header(T["explainer_header"])
        ec1, ec2 = st.columns(2)
        with ec1:
            st.subheader(T["explainer_marathi"])
            st.markdown(explanation.get("marathi", "—"))
        with ec2:
            st.subheader(T["explainer_english"])
            st.markdown(explanation.get("english", "—"))
        src = explanation.get("source", "template")
        src_label = T["explainer_source_gemini"] if src == "gemini" else T["explainer_source_template"]
        st.caption(f"_{src_label}_")
...
with tab_analysis:
    ...
    AGENT_ROLE = {
        ...
        "explainer":     ("📢 Agent 5", "Farmer Explainer",  "Gemini 2.0 LLM (mr+en)"),
